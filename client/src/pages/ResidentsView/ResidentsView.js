...
function ResidentsView() {
    ...
    const rows = [createData('Enter', 'Tue, 07 Feb 20 23 02:37:40 GMT'), createData('Exit', 'Tue, 07 Feb 20 23 02:37:40 GMT')];
            ...
            <div className="SectionHolder">
                <section className="Section">
                    <h3 className="SectionTitleDashboard">
                        ...
                        > <span>{resident.user.name.firstName + ' ' + resident.user.name.lastName}</span>
                    </h3>
                            ...
                            <div className="SectionView__Sections">
                                ...
                                <div id="GeneralInformation__Container">
                                    ...
                                    <div className="GeneralInformation__InfoContainer">
                                        <h6>Type: </h6>
                                        <h5>
                                            {resident.type} member ( {resident.title} )
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="SectionView__Sections">
                                ...
                                <div className="SectionList" id="Vehicles__Container">
                                    {resident.user.vehicles.length === 0 ? (
                                        ...
                                        <>
                                            {resident.user.vehicles.length > 0 &&
                                                resident.user.vehicles.map((vehicle) => {
                                                    return (
                                                        <Card
                                                            type="Vehicles"
