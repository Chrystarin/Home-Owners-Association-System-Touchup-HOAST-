                                ...
                                <div id="GeneralInformation__Car">
                                        ...
                                        {home ? (
                                            <>
                                                ...
                                                <div className="GeneralInformation__InfoContainer ">
                                                    ...
                                                    <h5>
                                                        {home.address.number} {home.address.street} {home.address.phase}
                                                    </h5>
                                                </div>
                                            </>
                                        ) : (
                                    ...
                                    <div className="Input__Wrapper2">
                                        ...
                                        <div className="GeneralInformation__InfoContainer">
                                            <h6>Arrival Date: </h6>
                                            <h5>
                                                {new Date(visitor.arrival).toLocaleString('default', {
                                                    month: 'long'
                                                }) +
                                                    ' ' +
                                                    ...
                                                    ':' +
                                                    new Date(visitor.arrival).getSeconds()}
                                            </h5>
                                        </div>
                                    </div>
                                    <div className="Input__Wrapper2">
                                        ...
                                        <div className="GeneralInformation__InfoContainer">
                                            ...
                                            <h5>
                                                {new Date(visitor.departure).toLocaleString('default', {
                                                    month: 'long'
                                                }) +
                                                    ' ' +
                                                    ...
                                                    ':' +
                                                    new Date(visitor.departure).getSeconds()}
                                            </h5>
                                        </div>
                                    </div>
                                    <div className="Input__Wrapper2">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <TableCell align="center">
                                                                            {new Date(log.createdAt).toLocaleString('default', {
                                                                                ...
                                                                                ' ' +
                                                                                (new Date(log.createdAt).getHours() >= 12 ? 'PM' : 'AM')}
                                                                        </TableCell>
                                                                    </TableRow>
                                                                );
                                                            })}
