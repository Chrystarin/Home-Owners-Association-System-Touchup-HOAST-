                    ...
                    <div id="HOA__Content">
                        ...
                        <div className="SectionController">
                            <div id="SearchInput__Container">
                                <SearchInput
                                    setData={setData}
                                    data={logs.map((data) => crawler(data))}
                                    keys={['logType', 'user.userId', 'vehicle.plateNumber', 'visitor.visitorId', 'user.name.firstName', 'user.name.lastName']}
                    ...
                    <div className="LogsModal">
                        <div className="LogsModal__Header">
                            {selectedValue?.logType === 'user' ? (
                                <>
                                    <h5>
                                        {selectedValue['user.name.firstName']} {selectedValue['user.name.lastName']}{' '}
                                    </h5>
                                </>
                            ) : (
                                ''
                            ...
                            {selectedValue?.logType === 'user' ? (
                                <>
                                    <li>
                                        ...
                                        <p>
                                            {new Date(selectedValue.createdAt).getMonth() +
                                                ' / ' +
                                                new Date(selectedValue.createdAt).getDate() +
                                                ' / ' +
                                                new Date(selectedValue.createdAt).getFullYear() +
                                                ' | ' +
                                                new Date(selectedValue.createdAt).getHours() +
                                                ':' +
                                                new Date(selectedValue.createdAt).getMinutes() +
                                                ':' +
                                                new Date(selectedValue.createdAt).getSeconds()}
                                        </p>
                                    </li>
                                </>
                            ) : (
                            ...
                            {selectedValue?.logType === 'visitor' ? (
                                <>
                                    <li>
                                        ...
                                        <p>
                                            {new Date(selectedValue['visitor.arrival']).getMonth() +
                                                ' / ' +
                                                new Date(selectedValue['visitor.arrival']).getDate() +
                                                ' / ' +
                                                new Date(selectedValue['visitor.arrival']).getFullYear() +
                                                ' | ' +
                                                new Date(selectedValue['visitor.arrival']).getHours() +
                                                ':' +
                                            ...
                                            {new Date(selectedValue['visitor.departure']).getMonth() +
                                                ...
                                                ' / ' +
                                                new Date(selectedValue['visitor.departure']).getFullYear() +
                                                ' | ' +
                                                new Date(selectedValue['visitor.departure']).getHours() +
                                                ':' +
                                                new Date(selectedValue['visitor.departure']).getMinutes() +
                                                ':' +
                                                new Date(selectedValue['visitor.departure']).getSeconds()}{' '}
                                        </p>
                                    </li>
                                    <li>
                                        <h6>Purpose: </h6>
